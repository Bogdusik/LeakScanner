      ...
      <div className="space-y-3">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <a
              href="https://github.com/settings/tokens/new?scopes=repo&description=LeakScanner"
              target="_blank"
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <a
              href="https://gitlab.com/-/user_settings/personal_access_tokens?name=LeakScanner&scopes=read_api,read_repository"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 text-xs text-rog-cyan hover:text-rog-cyanDark font-medium transition-colors"
            >
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <a
              href="https://app.snyk.io/manage/api-credentials"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 text-xs text-rog-cyan hover:text-rog-cyanDark font-medium transition-colors"
            >
